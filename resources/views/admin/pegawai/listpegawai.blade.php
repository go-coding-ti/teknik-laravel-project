  ...
  <div class="modal-dialog modal-dialog-centered">
          ...
          <div class="modal-body">
              <div class="text-center">
                  ...
                  <div>
                    ...
                    <br>
                    <a href="/admin/import/dosen" class= "btn btn-primary text-white" id="toggle" ><i class="fas fa-download"></i> Import Data Pegawai</a>
                    <a class= "btn btn-info text-white" id="toggle" ><i class="fas fa-upload"></i> Export Data Pegawai</a>
                  </div>
              </div>
          </div>
      </div>
    ...
    <div class="container-fluid">
        <div style="margin-left: 10px;" class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list"></i> Master Data Pegawai</h1>
        </div>
          <!-- DataTales Example -->
          <!-- Copy drisini -->
