...
<div class="container-fluid">
    ...
    <div style="margin-left: 10px;" class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list"></i> Tambah Data Jabatan Fungsional</h1>
    </div>
    <form method="POST" enctype="multipart/form-data" action="{{route('masterdata-jabatanfungsional-store')}}">
    @csrf
    <div class="card shadow">
        ...
        <div class="form-group card-body">    
            ...
            <input type="text" class="form-control" id="jabatan_fungsional" name="jabatan_fungsional" placeholder="Masukan Nama Jabatan Fungsional">
