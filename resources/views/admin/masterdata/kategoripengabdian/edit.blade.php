...
<div class="container-fluid">
    ...
    <div style="margin-left: 10px;" class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list"></i> Edit Data Kategori Pengabdian</h1>
    </div>
    <form method="POST" enctype="multipart/form-data" action="/admin/masterdata/kategoripengabdian/update/{{$datakpeng->id_kategori_pengabdian}}">
    @csrf
    <div class="card shadow">
        ...
        <div class="form-group card-body">    
            ...
            <textarea class="form-control" id="kategori_pengabdian" name="kategori_pengabdian" placeholder="Masukan Nama Kategori Pengabdian">{{$datakpeng->kategori_pengabdian}}</textarea>
