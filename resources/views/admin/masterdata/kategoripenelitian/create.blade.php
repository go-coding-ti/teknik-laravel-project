...
<div class="container-fluid">
    ...
    <div style="margin-left: 10px;" class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list"></i> Tambah Data Kategori Penelitian</h1>
    </div>
    <form method="POST" enctype="multipart/form-data" action="{{route('masterdata-kategoripenelitian-store')}}">
    @csrf
    <div class="card shadow">
        ...
        <div class="form-group card-body">    
            ...
            <textarea class="form-control" id="kategori_penelitian" name="kategori_penelitian" placeholder="Masukan Nama Kategori Penelitian"></textarea>
