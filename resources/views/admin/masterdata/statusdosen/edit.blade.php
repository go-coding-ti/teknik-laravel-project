...
<div class="container-fluid">
    ...
    <div style="margin-left: 10px;" class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list"></i> Edit Data Status Dosen</h1>
    </div>
    <form method="POST" enctype="multipart/form-data" action="/admin/masterdata/statusdosen/update/{{$datasd->id_status_dosen}}">
    @csrf
    <div class="card shadow">
        ...
        <div class="form-group card-body">    
            ...
            <textarea class="form-control" id="status_dosen" name="status_dosen" placeholder="Masukan Nama Status Dosen">{{$datasd->status_dosen}}</textarea>
